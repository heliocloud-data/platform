...
instance_types_master_dict = {
    'General Purpose': {
        ...
        'types': ['t2.nano', 't2.micro', 't2.small', 't2.medium', 'm5.large', 'm5.xlarge', 'm5.2xlarge', 'm5.4xlarge']
    },
    'Compute Optimized': {
        ...
        'types': ['c5.large', 'c5.xlarge', 'c5.2xlarge', 'c5.4xlarge', 'c5.9xlarge', 'c5.12xlarge', 'c5.18xlarge', 'c5.24xlarge', 'c5.metal'],
    },
    'Memory Optimized': {
        ...
        'types': ['r5.large', 'r5.xlarge', 'r5.2xlarge', 'r5.4xlarge', 'r5.8xlarge', 'r5.12xlarge', 'r5.16xlarge', 'r5.24xlarge', 'r5.metal'],
    },
    'Accelerated Compute': {
        ...
        'types': ['g4dn.xlarge', 'g4dn.2xlarge', 'g4dn.4xlarge', 'g4dn.8xlarge', 'g4dn.16xlarge', 'g4dn.12xlarge', 'g4dn.metal'],
    }
}
