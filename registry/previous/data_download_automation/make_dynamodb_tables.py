...
def create_fileregister_table(session, table_name, units):
    ...
    try:
        table = session.create_table(
            ...
            KeySchema=[
                {"AttributeName": "s3_filekey", "KeyType": "HASH"},  # Primary partition key
            ],
            GlobalSecondaryIndexes=[
                ...
                },
                {
                    ...
                    "KeySchema": [
                        ...
                        {"AttributeName": "date_upload", "KeyType": "RANGE"},
                    ],
                    "Projection": {"ProjectionType": "ALL"},
                    "ProvisionedThroughput": {
                        "ReadCapacityUnits": units,
                ...
                },
                {
                    ...
                    "KeySchema": [
                        {"AttributeName": "mission", "KeyType": "HASH"},
                        {"AttributeName": "start_date", "KeyType": "RANGE"},
                    ],
                    "Projection": {"ProjectionType": "ALL"},
                    "ProvisionedThroughput": {
                ...
                },
                {
                    "IndexName": "level_id",
                    "KeySchema": [
                        {"AttributeName": "level_processing", "KeyType": "HASH"},
                        {"AttributeName": "start_date", "KeyType": "RANGE"},
                    ],
                    "Projection": {"ProjectionType": "ALL"},
                    "ProvisionedThroughput": {
    ...
    try:
        table = session.create_table(
            AttributeDefinitions=[  # describes only the attributes that are used for the key schema of the table
                ...
                {"AttributeName": "instrument", "AttributeType": "S"},  # lists all the instruments
                {
            ...
            LocalSecondaryIndexes=[
                {
                    ...
                    "KeySchema": [
                        ...
                        {"AttributeName": "instrument", "KeyType": "RANGE"},
                    ],
                    "Projection": {"ProjectionType": "ALL"},
                }
            ],
...
def create_failure_table(session, table_name, units):
    ...
    try:
        table = session.create_table(
            AttributeDefinitions=[  # describes only the attributes that are used for the key schema of the table
                {"AttributeName": "s3_filekey", "AttributeType": "S"},  # lists all the instruments
            ...
            TableName=table_name,
            KeySchema=[{"AttributeName": "s3_filekey", "KeyType": "HASH"}],
            GlobalSecondaryIndexes=[
                {
                    "IndexName": "dataset_datesort",  # grabs all data within a 'dataset' and sorts by date
                    "KeySchema": [
...
if __name__ == "__main__":
    ...
    read_write_units = (
        10  # the read/write capacity for the table - weighs heavily on the cost of the table
    )
