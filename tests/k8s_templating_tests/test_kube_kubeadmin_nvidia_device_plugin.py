...
app_path="kubeadm/nvidia-device-plugin"

logical_test_name="test_kube_kubeadm_nvidia-device-plugin"
...
def test_something(snapshot):
    original_output_file=f"{test_workspace_dir}/ORIGINAL-kubeadm-nvidia-device-plugin.yaml"
    utils.run_kustomize(
    ...
    snapshot.assert_match(actual, "BASELINE-kubeadm-nvidia-device-plugin.yaml")
