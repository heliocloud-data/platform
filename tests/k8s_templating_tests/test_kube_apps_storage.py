...
app_path="apps/storage"

logical_test_name="test_kube_apps_storage"
...
def test_something(snapshot):
    original_output_file=f"{test_workspace_dir}/ORIGINAL-apps-storage.yaml"
    utils.run_kustomize(
    ...
    snapshot.assert_match(actual, "BASELINE-apps-storage.yaml")
