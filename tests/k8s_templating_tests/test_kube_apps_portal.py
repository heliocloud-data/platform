...
app_path="apps/portal"

logical_test_name="test_kube_apps_portal"
...
def test_something(snapshot):
    original_output_file=f"{test_workspace_dir}/ORIGINAL-apps-portal.yaml"
    utils.run_kustomize(
    ...
    snapshot.assert_match(actual, "BASELINE-apps-portal.yaml")
