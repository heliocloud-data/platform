...
Feature: Log into portal and launch an EC2 instance
  ...
  Scenario Outline:  Launch an EC2 instance (ami_name: <ami_name>)
    ...
    Examples:
      ...
      | helioptile-ec2-image-type-001 | Amazon Linux | al2023-ami-2023.9.20250929.0-kernel-6.12-x86_64                                      | General Purpose     | t2.micro      |                64 |
      | helioptile-ec2-image-type-002 | Amazon Linux | Deep Learning OSS Nvidia Driver AMI GPU PyTorch 2.8 (Amazon Linux 2023) 20251007     | General Purpose     | t2.micro      |                64 |
      | helioptile-ec2-image-type-003 | Amazon Linux | Deep Learning OSS Nvidia Driver AMI GPU TensorFlow 2.18 (Amazon Linux 2023) 20251007 | General Purpose     | t2.micro      |                64 |
      | helioptile-ec2-image-type-004 | Ubuntu       | Deep Learning OSS Nvidia Driver AMI GPU PyTorch 2.8 (Ubuntu 24.04) 20251007          | General Purpose     | t2.micro      |                64 |
