...
curl --location -o /usr/local/bin/kubectl https://s3.us-west-2.amazonaws.com/amazon-eks/1.35.3/2026-04-08/bin/linux/amd64/kubectl
...
apt-get update && DEBIAN_FRONTEND=noninteractive apt-get install jq less -y
