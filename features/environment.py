...
from utils.heliocloud_utils import (load_heliocloud_context)
...
def init_heliocloud_context(context):
    ...
    context_name = os.environ.get("HC_INSTANCE", None)
    context.heliocloud_context = load_heliocloud_context(context_name)

    context.hc_instance = context_name
    context.aws_default_region = context.heliocloud_context['aws_region']['value']
