...
class ProductDatabase():
    def __init__(self, data_request, destination_bucket):
        ...
        print('Scraping file data for {}'.format(
            self.product_name
        ))
    ...
    def href_year(self, href_string):
        ...
        :return:
        '''
        applicable_years = ['{}/'.format(i) for i in np.arange(2015, 2023)] #   EDIT THIS IF YOU WANT MORE DATA
    ...
    def href_month(self, href_string):
        ...
        :return:
        '''
        applicable_months = ['01/', '02/', '03/', '04/', '05/', '06/', '07/', '08/', '09/', '10/', '11/', '12/']
    ...
    def fetch_main_cdaweb_req(self):
        ...
        :return:
        '''
        self.core_path = 'https://cdaweb.gsfc.nasa.gov/pub/data/{}'.format(
            self.product
        )
    ...
    def fetch_filepaths(self):
        ...
        for year, month_list in self.year_months.items():
            ...
            for month in month_list:
                ...
                if content:
                    ...
                    cdaweb_sourcefile_df = ['{}{}/{}/{}'.format(self.core_path, year, month, i) for i in filepaths]
                    ...
                    calc_file_size = np.tile(np.nan, len(filepaths)) # this is Nan until calculated officially on file verification

                    tmp_df = pd.DataFrame({'s3_key': s3_keys_df,
        ...
        print('Total download size estimated at {} GB'.format(total_download_size / 1000.))
...
def make_request_dict(product, mission, spacecraft, instr, levelproc, instr_mode, source, source_type):
    '''
...
if __name__ == '__main__':
    ...
    for s in SC:
        req_list.append(make_request_dict(
            'mms/mms1/fgm/srvy/l2/',
            'mms',
            'mms1',
            'fgm',
            'l2',
