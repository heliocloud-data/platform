...
app_path="kubeadm/cluster-autoscaler"

logical_test_name="test_kube_kubeadm_cluster-autoscaler"
...
def test_something(snapshot):
    original_output_file=f"{test_workspace_dir}/ORIGINAL-kubeadm-cluster-autoscaler.yaml"
    utils.run_kustomize(
    ...
    snapshot.assert_match(actual, "BASELINE-kubeadm-cluster-autoscaler.yaml")
